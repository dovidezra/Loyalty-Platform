<div class="container">
  ...
  <div class="row m-t">
    <div class="col-sm-12">
      <div class="card-box">
        <h4 class="page-title m-0">{{ trans('global.admin') }} &rsaquo; {{ trans('global.users') }} &rsaquo; {{ trans('global.edit_user') }}</h4>
      </div>
    </div>
  </div>
            ...
            <fieldset>
              <div class="form-group">
                <?php
                  ...
                  if ($user->id == 1 || ($user->reseller == 1 && $user->reseller_id != NULL)) $roles->disabled();
